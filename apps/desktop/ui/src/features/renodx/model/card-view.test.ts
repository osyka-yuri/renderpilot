...
const cardViewCases = [
  ...
  {
    name: 'blocked by other addon takes precedence over unsupported settings guidance',
    flags: { isBlockedByOtherAddon: true, hasUnsupportedSettings: true },
    expected: 'blocked-by-other-addon',
  },
  {
    name: 'unsupported settings requirement',
    flags: { hasUnsupportedSettings: true },
    expected: 'unsupported-settings',
  },
  {
    name: 'installed view remains selected for an installed title with unsupported settings',
    flags: { isInstalled: true, hasUnsupportedSettings: true },
    expected: 'installed',
  },
