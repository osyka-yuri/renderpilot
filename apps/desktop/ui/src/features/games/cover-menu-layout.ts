...
export const COVER_MENU_GAP = 6;

type MenuPanelLayoutOptions = {
  viewportMargin?: number;
  gap?: number;
  zIndex?: string;
};

const DEFAULT_LAYOUT_OPTIONS: Required<MenuPanelLayoutOptions> = {
  viewportMargin: VIEWPORT_MENU_MARGIN,
  gap: COVER_MENU_GAP,
  zIndex: '50',
};
 ...
 */
export function layoutCoverMenuPanel(
  trigger: HTMLElement,
  panel: HTMLElement,
  options: MenuPanelLayoutOptions = {},
): void {
...
export function attachCoverMenuResizeScroll(schedule: () => void): () => void {
