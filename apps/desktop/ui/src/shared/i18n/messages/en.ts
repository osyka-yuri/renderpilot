...
export const en = {
  ...
  'nvapi.dlss_sr_render_preset.description':
    'Forces a specific DLSS preset. Some games may require "Forced Profile" to apply custom presets.',
  ...
  'nvapi.dlss_sr_quality_level.description': 'Overrides the in-game DLSS quality selection.',
  ...
  'nvapi.dlss_sr_scaling_ratio.description':
    'Sets a custom render resolution. Requires "Forced Quality Level" to be Custom.',

  'nvapi.dlss_sr_dll_override.label': 'Enable DLL Override',
  'nvapi.dlss_sr_dll_override.description':
    'Forces the game to use the latest DLSS version installed system-wide.',
  ...
  'nvapi.dlss_sr_model_preset_profile.description':
    'Allows applying a custom preset in games where "Render Preset" has no effect.',
  ...
  'nvapi.dlss_sr_override_dlaa.description':
    'Renders every DLSS quality mode at full resolution (DLAA).',
  ...
  'nvapi.dlss_sr_override_perf_to_ultraperf.description':
    'Forces the Performance mode to use the Ultra Performance rendering path.',
  ...
  'nvapi.dlss_fg_render_preset.description': 'Forces a specific Frame Generation preset.',
  ...
  'nvapi.dlss_fg_mode.description':
    'Sets the Frame Generation mode. Dynamic mode requires driver 595.97+.',
  ...
  'nvapi.dlss_fg_dll_override.description':
    'Forces the game to use the latest Frame Generation version installed system-wide.',
  ...
  'nvapi.dlss_mfg_dynamic_count.description':
    'Sets an upper limit on generated frames when using Dynamic mode.',
  'nvapi.dlss_mfg_dynamic_count.value.na': 'N/A',

  'nvapi.dlss_mfg_target_frame_rate.label': 'Multi-Frame Generation — Target Frame Rate',
  'nvapi.dlss_mfg_target_frame_rate.description':
    'Sets the target frame rate for Dynamic Frame Generation.',
  ...
  'nvapi.dlss_rr_render_preset.description': 'Forces a specific Ray Reconstruction preset.',
  ...
  'nvapi.dlss_rr_quality_level.description':
    'Overrides the in-game Ray Reconstruction quality selection.',
  ...
  'nvapi.dlss_rr_dll_override.description':
    'Forces the game to use the latest Ray Reconstruction version installed system-wide.',
