...
export const ja: Record<MessageKey, MessageValue> = {
  ...
  'gameDetails.renodx.confidenceVerified': '検証済み',
  'gameDetails.renodx.confidenceExperimental': '実験的',
  'gameDetails.renodx.confidenceUntested': '未検証',
  ...
  'gameDetails.renodx.fileInstall.description':
    'このゲームには自動アドオンがありません。ReShade ホストをインストールし、自分でダウンロードした RenoDX アドオンを追加します。',
  ...
  'gameDetails.renodx.updateAvailableAddon': 'アドオンの更新',
  'gameDetails.renodx.updateAvailableHost': 'ReShadeの更新',
  'gameDetails.renodx.updateAvailableBoth': 'アドオンとReShadeの更新',
  'gameDetails.renodx.updatesNotTracked': '更新は追跡されません',
  'gameDetails.renodx.hostManaged': 'RenderPilot が管理 — 自動的に最新へ更新',
  'gameDetails.renodx.hostForeign': 'ご自身のインストール — RenderPilot は変更しません',
  ...
  'gameDetails.renodx.dlssFixInstalled': 'DLSS-Fixインストール済み',
