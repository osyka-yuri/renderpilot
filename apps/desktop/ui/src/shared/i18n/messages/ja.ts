...
export const ja: Record<MessageKey, MessageValue> = {
  ...
  'game.card.action.journal': 'ジャーナル',
  'game.card.action.detailsAria': '{title} の詳細を開く',
  'game.card.action.journalAria': '{title} のジャーナルを開く',
  ...
  'operations.title': '履歴',
  'operations.subtitleAll': 'すべてのアクティビティ',
  'operations.subtitleGame': '{title} のアクティビティ',
  'operations.viewGame': 'ゲームを見る',
  'operations.loading': '読み込み中...',
  'operations.empty': '履歴はまだありません',
  'operations.historyAria': 'アクティビティ履歴',
  'operations.items': '項目',
