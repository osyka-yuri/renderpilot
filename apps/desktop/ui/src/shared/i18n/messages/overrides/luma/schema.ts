/**
 * Locale-neutral Luma Guidance key groups.
 *
 * The groups are intentionally kept separate from translated phrases so the
 * locale packs can load only one language's reviewed copy.
 */
