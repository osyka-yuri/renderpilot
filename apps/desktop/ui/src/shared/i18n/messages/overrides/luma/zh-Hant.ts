...
const translations = {
  ...
  scornOptiscaler:
    '遊戲原生支援 FSR 2.1，因此可透過 OptiScaler 加入 DLSS 或其他超高解析度升頻工具。',
  ...
  bundledDlss: 'Luma 會保留遊戲隨附的 DLSS 程式庫，並在移除時將其還原。',
  ...
  massEffectNativeAa: '僅提供 DLAA / FSR 3 Native AA 模式；這並非 DLSS 或 FSR 超高解析度功能。',
  metaphorNativeAa: '僅提供 DLAA / FSR Native AA 模式；這並非 DLSS 或 FSR 超高解析度功能。',
...
export const lumaGuidanceOverrides = defineLocalizedOverrides<'zh-Hant', LumaSourceCatalog>()(
