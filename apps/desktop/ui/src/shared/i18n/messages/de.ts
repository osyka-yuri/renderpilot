...
export const de = defineLocalizedCatalog<'de', EnglishCatalog>()({
  ...
  'shell.refreshing': 'Wird aktualisiert…',
  ...
  'gameDetails.renodx.unsupportedSettings':
    'Diese Version von RenderPilot unterstützt einige RenoDX-Einstellungen für dieses Spiel nicht.',
  ...
  'gameDetails.optiscaler.compatibilityUntested': 'Ungeprüft',
