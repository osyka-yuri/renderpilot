...
export const de: Record<MessageKey, MessageValue> = {
  ...
  'game.card.action.journal': 'Protokoll',
  'game.card.action.detailsAria': 'Details für {title} öffnen',
  'game.card.action.journalAria': 'Protokoll für {title} öffnen',
  ...
  'operations.title': 'Verlauf',
  'operations.subtitleAll': 'Alle Aktivitäten',
  'operations.subtitleGame': 'Aktivität für {title}',
  'operations.viewGame': 'Spiel anzeigen',
  'operations.loading': 'Laden...',
  'operations.empty': 'Noch kein Verlauf',
  'operations.historyAria': 'Aktivitätsverlauf',
  'operations.items': 'Elemente',
