...
export const zh: Record<MessageKey, MessageValue> = {
  ...
  'gameDetails.renodx.confidenceVerified': '已验证',
  'gameDetails.renodx.confidenceExperimental': '实验性',
  'gameDetails.renodx.confidenceUntested': '未测试',
  ...
  'gameDetails.renodx.channel.label': 'ReShade 通道',
