...
export const zh: Record<MessageKey, MessageValue> = {
  ...
  'gameDetails.renodx.fileInstall.description':
    '此游戏没有自动插件。安装 ReShade 主机，并添加你自行下载的 RenoDX 插件。',
  ...
  'gameDetails.renodx.updateAvailableAddon': '附加组件更新',
  'gameDetails.renodx.updateAvailableHost': 'ReShade 更新',
  'gameDetails.renodx.updateAvailableBoth': '附加组件和 ReShade 更新',
  'gameDetails.renodx.updatesNotTracked': '未跟踪更新',
  'gameDetails.renodx.hostManaged': '由 RenderPilot 管理 — 自动保持最新',
  'gameDetails.renodx.hostForeign': '你自己的安装 — RenderPilot 不会改动',
  ...
  'gameDetails.renodx.dlssFixInstalled': '已安装 DLSS-Fix',
