...
export const zh: Record<MessageKey, MessageValue> = {
  ...
  'gameDetails.renodx.uninstallConfirmBody':
    '这会移除此游戏的 RenoDX 插件和由 RenderPilot 管理的 ReShade 文件，并在可用时恢复备份文件。',
  'gameDetails.renodx.uninstallConfirmAction': '移除',
  'gameDetails.renodx.installing': '正在安装…',
  'gameDetails.renodx.riskSafe': '单人游戏——可安全安装。',
  ...
  'gameDetails.renodx.channel.stableUnavailable': '此清单不提供 Stable',
  'gameDetails.renodx.channel.switchTo': '切换到 {channel}',
  'gameDetails.renodx.host.version': 'ReShade {version}',
  'gameDetails.renodx.host.versionUnknown': 'ReShade 版本未知',
  ...
  'gameDetails.renodx.host.action.reinstall_with_addon_support': '需要支持插件的版本',
  'gameDetails.renodx.host.action.repair_host': '建议修复',
  'gameDetails.renodx.host.action.conflict': '槽位冲突',
  'gameDetails.renodx.host.health.missing': 'ReShade 文件缺失',
  'gameDetails.renodx.host.health.conflicting': 'ReShade 冲突',
  ...
  'gameDetails.renodx.updateAvailableDlssFix': 'DLSS-Fix 有可用更新',
