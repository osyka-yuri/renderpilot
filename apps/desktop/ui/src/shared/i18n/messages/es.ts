...
export const es: Record<MessageKey, MessageValue> = {
  ...
  'game.card.action.journal': 'Diario',
  'game.card.action.detailsAria': 'Abrir detalles de {title}',
  'game.card.action.journalAria': 'Abrir diario de {title}',
  ...
  'operations.subtitleAll': 'Todas las actividades',
  'operations.subtitleGame': 'Actividad de {title}',
  'operations.viewGame': 'Ver juego',
  'operations.loading': 'Cargando...',
  'operations.empty': 'Aún no hay historial',
  'operations.historyAria': 'Historial de actividades',
  'operations.items': 'Elementos',
