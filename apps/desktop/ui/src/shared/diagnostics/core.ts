...
export const consoleErrorDiagnosticSink: ErrorDiagnosticSink = {
...
let sink: ErrorDiagnosticSink = consoleErrorDiagnosticSink;
...
export function configureErrorDiagnosticSink(next: ErrorDiagnosticSink | null): void {
  sink = next ?? consoleErrorDiagnosticSink;
}
