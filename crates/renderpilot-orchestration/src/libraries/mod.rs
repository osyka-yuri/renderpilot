...
pub async fn download_library(
    ...
    let downloaded = local_library::ensure_downloaded_and_registered(context, &entry).await?;
...
pub async fn download_artifact(
    ...
    {
        let registered =
            local_library::ensure_package_downloaded(context, &manifest, &package).await?;
