...
//! filtering in [`crate::desktop::nvapi`] apply to those — and nothing else.
...
pub enum CatalogError {
    ...
    DuplicateKey(String),
    EmptyValues(String),
    DuplicateWire { key: String, wire: String },
    DuplicateDword { key: String, dword: u32 },
    DefaultNotInValues { key: String, dword: u32 },
}
